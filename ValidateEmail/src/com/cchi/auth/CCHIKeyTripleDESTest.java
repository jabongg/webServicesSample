...
public class CCHIKeyTripleDESTest {
	...
	private static void generateKey() throws Exception {
	    ...
	    String codedtext = new CCHIKeyTripleDESTest()._encrypt(text,"SecretKey");
	    String decodedtext = new CCHIKeyTripleDESTest()._decrypt(codedtext,"SecretKey");
